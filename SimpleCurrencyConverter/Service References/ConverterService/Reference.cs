...
//
namespace SimpleCurrencyConverter.ConverterService
{
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace = "http://www.webserviceX.NET/", ConfigurationName = "ConverterService.CurrencyConvertorSoap")]
    public interface CurrencyConvertorSoap
    {
        ...
        System.IAsyncResult BeginConversionRate(SimpleCurrencyConverter.ConverterService.Currency FromCurrency, SimpleCurrencyConverter.ConverterService.Currency ToCurrency, System.AsyncCallback callback, object asyncState);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface CurrencyConvertorSoapChannel : SimpleCurrencyConverter.ConverterService.CurrencyConvertorSoap, System.ServiceModel.IClientChannel
    {
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class CurrencyConvertorSoapClient : System.ServiceModel.ClientBase<SimpleCurrencyConverter.ConverterService.CurrencyConvertorSoap>, SimpleCurrencyConverter.ConverterService.CurrencyConvertorSoap
    {
        ...
        System.IAsyncResult SimpleCurrencyConverter.ConverterService.CurrencyConvertorSoap.BeginConversionRate(SimpleCurrencyConverter.ConverterService.Currency FromCurrency, SimpleCurrencyConverter.ConverterService.Currency ToCurrency, System.AsyncCallback callback, object asyncState)
        {
            return base.Channel.BeginConversionRate(FromCurrency, ToCurrency, callback, asyncState);
        }

        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        double SimpleCurrencyConverter.ConverterService.CurrencyConvertorSoap.EndConversionRate(System.IAsyncResult result)
        {
        ...
        {
            SimpleCurrencyConverter.ConverterService.Currency FromCurrency = ((SimpleCurrencyConverter.ConverterService.Currency)(inValues[0]));
            SimpleCurrencyConverter.ConverterService.Currency ToCurrency = ((SimpleCurrencyConverter.ConverterService.Currency)(inValues[1]));
            return ((SimpleCurrencyConverter.ConverterService.CurrencyConvertorSoap)(this)).BeginConversionRate(FromCurrency, ToCurrency, callback, asyncState);
        }

        private object[] OnEndConversionRate(System.IAsyncResult result)
        {
            double retVal = ((SimpleCurrencyConverter.ConverterService.CurrencyConvertorSoap)(this)).EndConversionRate(result);
            return new object[] {
                    retVal};
        }
        ...
        public void ConversionRateAsync(SimpleCurrencyConverter.ConverterService.Currency FromCurrency, SimpleCurrencyConverter.ConverterService.Currency ToCurrency)
        {
            this.ConversionRateAsync(FromCurrency, ToCurrency, null);
        }

        public void ConversionRateAsync(SimpleCurrencyConverter.ConverterService.Currency FromCurrency, SimpleCurrencyConverter.ConverterService.Currency ToCurrency, object userState)
        {
        ...
        protected override SimpleCurrencyConverter.ConverterService.CurrencyConvertorSoap CreateChannel()
        {
            return new CurrencyConvertorSoapClientChannel(this);
        }

        private class CurrencyConvertorSoapClientChannel : ChannelBase<SimpleCurrencyConverter.ConverterService.CurrencyConvertorSoap>, SimpleCurrencyConverter.ConverterService.CurrencyConvertorSoap
        {
            public CurrencyConvertorSoapClientChannel(System.ServiceModel.ClientBase<SimpleCurrencyConverter.ConverterService.CurrencyConvertorSoap> client) :
                base(client)
            {
            }

            public System.IAsyncResult BeginConversionRate(SimpleCurrencyConverter.ConverterService.Currency FromCurrency, SimpleCurrencyConverter.ConverterService.Currency ToCurrency, System.AsyncCallback callback, object asyncState)
            {
